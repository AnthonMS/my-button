 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,i,n){const o=e[0];if("."===o){return new P(t,e.slice(1),i).parts}if("@"===o)return[new E(t,e.slice(1),n.eventContext)];if("?"===o)return[new k(t,e.slice(1),i)];return new $(t,e,i).parts}handleTextExpression(t){return new T(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.3.0");const z=(t,...e)=>new b(t,e,"html",H)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
(window.litElementVersions||(window.litElementVersions=[])).push("2.4.0");const it={};class nt extends W{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const t=this.getStyles();if(Array.isArray(t)){const e=(t,i)=>t.reduceRight((t,i)=>Array.isArray(i)?e(i,t):(t.add(i),t),i),i=e(t,new Set),n=[];i.forEach(t=>n.unshift(t)),this._styles=n}else this._styles=void 0===t?[]:[t];this._styles=this._styles.map(t=>{if(t instanceof CSSStyleSheet&&!K){const e=Array.prototype.slice.call(t.cssRules).reduce((t,e)=>t+e.cssText,"");return new tt(String(e),Q)}return t})}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?K?this.renderRoot.adoptedStyleSheets=t.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map(t=>t.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){const e=this.render();super.update(t),e!==it&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)}))}render(){return it}}nt.finalized=!0,nt.render=(t,e,n)=>{if(!n||"object"!=typeof n||!n.scopeName)throw new Error("The `scopeName` option is required.");const o=n.scopeName,s=D.has(e),r=L&&11===e.nodeType&&!!e.host,a=r&&!j.has(o),l=a?document.createDocumentFragment():e;if(((t,e,n)=>{let o=D.get(e);void 0===o&&(i(e,e.firstChild),D.set(e,o=new T(Object.assign({templateFactory:O},n))),o.appendInto(e)),o.setValue(t),o.commit()})(t,l,Object.assign({templateFactory:U(o)},n)),a){const t=D.get(l);D.delete(l);const n=t.value instanceof y?t.value.template:void 0;I(o,l,n),i(e,e.firstChild),e.appendChild(l),D.set(e,t)}!s&&r&&window.ShadyCSS.styleElement(e.host)};var ot=/d{1,4}|M{1,4}|YY(?:YY)?|S{1,3}|Do|ZZ|Z|([HhMsDm])\1?|[aA]|"[^"]*"|'[^']*'/g,st="[^\\s]+",rt=/\[([^]*?)\]/gm;function at(t,e){for(var i=[],n=0,o=t.length;n<o;n++)i.push(t[n].substr(0,e));return i}var lt=function(t){return function(e,i){var n=i[t].map((function(t){return t.toLowerCase()})).indexOf(e.toLowerCase());return n>-1?n:null}};function ct(t){for(var e=[],i=1;i<arguments.length;i++)e[i-1]=arguments[i];for(var n=0,o=e;n<o.length;n++){var s=o[n];for(var r in s)t[r]=s[r]}return t}var dt=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],ht=["January","February","March","April","May","June","July","August","September","October","November","December"],ut=at(ht,3),pt={dayNamesShort:at(dt,3),dayNames:dt,monthNamesShort:ut,monthNames:ht,amPm:["am","pm"],DoFn:function(t){return t+["th","st","nd","rd"][t%10>3?0:(t-t%10!=10?1:0)*t%10]}},gt=ct({},pt),ft=function(t,e){for(void 0===e&&(e=2),t=String(t);t.length<e;)t="0"+t;return t},mt={D:function(t){return String(t.getDate())},DD:function(t){return ft(t.getDate())},Do:function(t,e){return e.DoFn(t.getDate())},d:function(t){return String(t.getDay())},dd:function(t){return ft(t.getDay())},ddd:function(t,e){return e.dayNamesShort[t.getDay()]},dddd:function(t,e){return e.dayNames[t.getDay()]},M:function(t){return String(t.getMonth()+1)},MM:function(t){return ft(t.getMonth()+1)},MMM:function(t,e){return e.monthNamesShort[t.getMonth()]},MMMM:function(t,e){return e.monthNames[t.getMonth()]},YY:function(t){return ft(String(t.getFullYear()),4).substr(2)},YYYY:function(t){return ft(t.getFullYear(),4)},h:function(t){return String(t.getHours()%12||12)},hh:function(t){return ft(t.getHours()%12||12)},H:function(t){return String(t.getHours())},HH:function(t){return ft(t.getHours())},m:function(t){return String(t.getMinutes())},mm:function(t){return ft(t.getMinutes())},s:function(t){return String(t.getSeconds())},ss:function(t){return ft(t.getSeconds())},S:function(t){return String(Math.round(t.getMilliseconds()/100))},SS:function(t){return ft(Math.round(t.getMilliseconds()/10),2)},SSS:function(t){return ft(t.getMilliseconds(),3)},a:function(t,e){return t.getHours()<12?e.amPm[0]:e.amPm[1]},A:function(t,e){return t.getHours()<12?e.amPm[0].toUpperCase():e.amPm[1].toUpperCase()},ZZ:function(t){var e=t.getTimezoneOffset();return(e>0?"-":"+")+ft(100*Math.floor(Math.abs(e)/60)+Math.abs(e)%60,4)},Z:function(t){var e=t.getTimezoneOffset();return(e>0?"-":"+")+ft(Math.floor(Math.abs(e)/60),2)+":"+ft(Math.abs(e)%60,2)}},vt=function(t){return+t-1},yt=[null,"[1-9]\\d?"],_t=[null,st],wt=["isPm",st,function(t,e){var i=t.toLowerCase();return i===e.amPm[0]?0:i===e.amPm[1]?1:null}],bt=["timezoneOffset","[^\\s]*?[\\+\\-]\\d\\d:?\\d\\d|[^\\s]*?Z?",function(t){var e=(t+"").match(/([+-]|\d\d)/gi);if(e){var i=60*+e[1]+parseInt(e[2],10);return"+"===e[0]?i:-i}return 0}],St=(lt("monthNamesShort"),lt("monthNames"),{default:"ddd MMM DD YYYY HH:mm:ss",shortDate:"M/D/YY",mediumDate:"MMM D, YYYY",longDate:"MMMM D, YYYY",fullDate:"dddd, MMMM D, YYYY",isoDate:"YYYY-MM-DD",isoDateTime:"YYYY-MM-DDTHH:mm:ssZ",shortTime:"HH:mm",mediumTime:"HH:mm:ss",longTime:"HH:mm:ss.SSS"});var xt=function(t,e,i){if(void 0===e&&(e=St.default),void 0===i&&(i={}),"number"==typeof t&&(t=new Date(t)),"[object Date]"!==Object.prototype.toString.call(t)||isNaN(t.getTime()))throw new Error("Invalid Date pass to format");var n=[];e=(e=St[e]||e).replace(rt,(function(t,e){return n.push(e),"@@@"}));var o=ct(ct({},gt),i);return(e=e.replace(ot,(function(e){return mt[e](t,o)}))).replace(/@@@/g,(function(){return n.shift()}))};(function(){try{(new Date).toLocaleDateString("i")}catch(t){return"RangeError"===t.name}})(),function(){try{(new Date).toLocaleString("i")}catch(t){return"RangeError"===t.name}}(),function(){try{(new Date).toLocaleTimeString("i")}catch(t){return"RangeError"===t.name}}();var $t=["closed","locked","off"],Ct=function(t,e,i,n){n=n||{},i=null==i?{}:i;var o=new Event(e,{bubbles:void 0===n.bubbles||n.bubbles,cancelable:Boolean(n.cancelable),composed:void 0===n.composed||n.composed});return o.detail=i,t.dispatchEvent(o),o},Tt=function(t){Ct(window,"haptic",t)},kt=function(t,e,i,n){var o;if("double_tap"===n&&i.double_tap_action?o=i.double_tap_action:"hold"===n&&i.hold_action?o=i.hold_action:"tap"===n&&i.tap_action&&(o=i.tap_action),o||(o={action:"more-info"}),!o.confirmation||o.confirmation.exemptions&&o.confirmation.exemptions.some((function(t){return t.user===e.user.id}))||(Tt("warning"),confirm(o.confirmation.text||"Are you sure you want to "+o.action+"?")))switch(o.action){case"more-info":(i.entity||i.camera_image)&&Ct(t,"hass-more-info",{entityId:i.entity?i.entity:i.camera_image});break;case"navigate":o.navigation_path&&function(t,e,i){void 0===i&&(i=!1),i?history.replaceState(null,"",e):history.pushState(null,"",e),Ct(window,"location-changed",{replace:i})}(0,o.navigation_path);break;case"url":o.url_path&&window.open(o.url_path);break;case"toggle":i.entity&&(function(t,e){(function(t,e,i){void 0===i&&(i=!0);var n,o=function(t){return t.substr(0,t.indexOf("."))}(e),s="group"===o?"homeassistant":o;switch(o){case"lock":n=i?"unlock":"lock";break;case"cover":n=i?"open_cover":"close_cover";break;default:n=i?"turn_on":"turn_off"}t.callService(s,n,{entity_id:e})})(t,e,$t.includes(t.states[e].state))}(e,i.entity),Tt("success"));break;case"call-service":if(!o.service)return void Tt("failure");var s=o.service.split(".",2);e.callService(s[0],s[1],o.service_data),Tt("success")}};function Pt(t){return void 0!==t&&"none"!==t.action}const Nt={required:{icon:"tune",name:"Required",secondary:"Required options for this card to function",show:!0},actions:{icon:"gesture-tap-hold",name:"Actions",secondary:"Perform actions based on tapping/clicking",show:!1,options:{tap:{icon:"gesture-tap",name:"Tap",secondary:"Set the action to perform on tap",show:!1},hold:{icon:"gesture-tap-hold",name:"Hold",secondary:"Set the action to perform on hold",show:!1},double_tap:{icon:"gesture-double-tap",name:"Double Tap",secondary:"Set the action to perform on double tap",show:!1}}},appearance:{icon:"palette",name:"Appearance",secondary:"Customize the name, icon, etc",show:!1}};let Mt=class extends nt{constructor(){super(...arguments),this._initialized=!1}setConfig(t){this._config=t,this.loadCardHelpers()}shouldUpdate(){return this._initialized||this._initialize(),!0}get _name(){var t;return(null===(t=this._config)||void 0===t?void 0:t.name)||""}get _entity(){var t;return(null===(t=this._config)||void 0===t?void 0:t.entity)||""}get _show_warning(){var t;return(null===(t=this._config)||void 0===t?void 0:t.show_warning)||!1}get _show_error(){var t;return(null===(t=this._config)||void 0===t?void 0:t.show_error)||!1}get _tap_action(){var t;return(null===(t=this._config)||void 0===t?void 0:t.tap_action)||{action:"more-info"}}get _hold_action(){var t;return(null===(t=this._config)||void 0===t?void 0:t.hold_action)||{action:"none"}}get _double_tap_action(){var t;return(null===(t=this._config)||void 0===t?void 0:t.double_tap_action)||{action:"none"}}render(){if(!this.hass||!this._helpers)return z``;this._helpers.importMoreInfoControl("climate");const t=Object.keys(this.hass.states).filter(t=>"sun"===t.substr(0,t.indexOf(".")));return z`
    ...
    `}};t([X({attribute:!1})],Mt.prototype,"hass",void 0),t([G()],Mt.prototype,"_config",void 0),t([G()],Mt.prototype,"_toggle",void 0),t([G()],Mt.prototype,"_helpers",void 0),Mt=t([J("boilerplate-card-editor")],Mt);const Et="ontouchstart"in window||navigator.maxTouchPoints>0||navigator.msMaxTouchPoints>0;class At extends HTMLElement{constructor(){super(),this.holdTime=500,this.held=!1,this.ripple=document.createElement("mwc-ripple")}connectedCallback(){Object.assign(this.style,{position:"absolute",width:Et?"100px":"50px",height:Et?"100px":"50px",transform:"translate(-50%, -50%)",pointerEvents:"none",zIndex:"999"}),this.appendChild(this.ripple),this.ripple.primary=!0,["touchcancel","mouseout","mouseup","touchmove","mousewheel","wheel","scroll"].forEach(t=>{document.addEventListener(t,()=>{clearTimeout(this.timer),this.stopAnimation(),this.timer=void 0},{passive:!0})})}bind(t,e){if(t.actionHandler)return;t.actionHandler=!0,t.addEventListener("contextmenu",t=>{const e=t||window.event;return e.preventDefault&&e.preventDefault(),e.stopPropagation&&e.stopPropagation(),e.cancelBubble=!0,e.returnValue=!1,!1});const i=t=>{let e,i;this.held=!1,t.touches?(e=t.touches[0].pageX,i=t.touches[0].pageY):(e=t.pageX,i=t.pageY),this.timer=window.setTimeout(()=>{this.startAnimation(e,i),this.held=!0},this.holdTime)},n=i=>{i.preventDefault(),["touchend","touchcancel"].includes(i.type)&&void 0===this.timer||(clearTimeout(this.timer),this.stopAnimation(),this.timer=void 0,this.held?Ct(t,"action",{action:"hold"}):e.hasDoubleClick?"click"===i.type&&i.detail<2||!this.dblClickTimeout?this.dblClickTimeout=window.setTimeout(()=>{this.dblClickTimeout=void 0,Ct(t,"action",{action:"tap"})},250):(clearTimeout(this.dblClickTimeout),this.dblClickTimeout=void 0,Ct(t,"action",{action:"double_tap"})):Ct(t,"action",{action:"tap"}))};t.addEventListener("touchstart",i,{passive:!0}),t.addEventListener("touchend",n),t.addEventListener("touchcancel",n),t.addEventListener("mousedown",i,{passive:!0}),t.addEventListener("click",n),t.addEventListener("keyup",t=>{13===t.keyCode&&n(t)})}startAnimation(t,e){Object.assign(this.style,{left:t+"px",top:e+"px",display:null}),this.ripple.disabled=!1,this.ripple.active=!0,this.ripple.unbounded=!0}stopAnimation(){this.ripple.active=!1,this.ripple.disabled=!0,this.style.display="none"}}customElements.define("action-handler-boilerplate",At);const Ot=(t,e)=>{const i=(()=>{const t=document.body;if(t.querySelector("action-handler-boilerplate"))return t.querySelector("action-handler-boilerplate");const e=document.createElement("action-handler-boilerplate");return t.appendChild(e),e})();i&&i.bind(t,e)},Vt=(Dt=(t={})=>e=>{Ot(e.committer.element,t)},(...t)=>{const e=Dt(...t);return g.set(e,!0),e});var Dt;var Ht={version:"Version",invalid_configuration:"Invalid configuration",show_warning:"Show Warning",show_error:"Show Error"},zt={common:Ht},Yt={version:"Versjon",invalid_configuration:"Ikke gyldig konfiguration",show_warning:"Vis advarsel"},Lt={common:Yt};const Ut={en:Object.freeze({__proto__:null,common:Ht,default:zt}),nb:Object.freeze({__proto__:null,common:Yt,default:Lt})};function Rt(t,e="",i=""){const n=(localStorage.getItem("selectedLanguage")||"en").replace(/['"]+/g,"").replace("-","_");let o;try{o=t.split(".").reduce((t,e)=>t[e],Ut[n])}catch(e){o=t.split(".").reduce((t,e)=>t[e],Ut.en)}return void 0===o&&(o=t.split(".").reduce((t,e)=>t[e],Ut.en)),""!==e&&""!==i&&(o=o.replace(e,i)),o}console.info(`%c  MY-BUTTON-LIGHT \n%c  ${Rt("common.version")} 0.0.1    `,"color: orange; font-weight: bold; background: green","color: white; font-weight: bold; background: dimgray"),window.customCards=window.customCards||[],window.customCards.push({type:"my-button-light",name:"My Button Light",description:"This is just my custom button card, it does what I need it to do without to much customization."});let jt=class extends nt{static async getConfigElement(){return document.createElement("boilerplate-card-editor")}static getStubConfig(){return{}}static get properties(){return{hass:{},config:{},active:{}}}setConfig(t){if(!t)throw new Error(Rt("common.invalid_configuration"));if(!t.entity)throw new Error("You need to define an entity");this.config=Object.assign({name:"MyButtonLight"},t)}shouldUpdate(t){return!!this.config&&function(t,e,i){if(e.has("config")||i)return!0;if(t.config.entity){var n=e.get("hass");return!n||n.states[t.config.entity]!==t.hass.states[t.config.entity]}return!1}(this,t,!1)}render(){var t;console.log("Test-Card Config:",this.config);var e=JSON.parse(JSON.stringify(this.config));const i=this.config.entity,n=null===(t=this.config.entity)||void 0===t?void 0:t.split(".")[1],o=this.hass.states[""+i];console.log("ENTITY:::",o),e.row1=e.row1?e.row1:{},e.row2=e.row2?e.row2:{},e.row3=e.row3?e.row3:{},e.slider=e.slider?e.slider:{},e.styles=e.styles?e.styles:{},e.styles.card=e.styles.card?e.styles.card:{},e.styles.icon=e.styles.icon?e.styles.icon:{},e.styles.slider=e.styles.slider?e.styles.slider:{},e.styles.text=e.styles.text?e.styles.text:{},e.styles.text.row1=e.styles.text.row1?e.styles.text.row1:{},e.styles.text.row2=e.styles.text.row2?e.styles.text.row2:{},e.styles.text.row3=e.styles.text.row3?e.styles.text.row3:{};let s=e.actionArea?e.actionArea:"main",r=e.styles.card.height?e.styles.card.height:"100%",a=e.styles.card.width?e.styles.card.width:"100%";this.style.height=r,this.style.width=a;let l=this.offsetWidth,c=this.offsetHeight;window.addEventListener("resize",()=>{l=this.offsetWidth,c=this.offsetHeight});let d=e.styles.card.borderRadius?e.styles.card.borderRadius:"10%",h=e.styles.card.backgroundColor?e.styles.card.backgroundColor:"rgba(255, 255, 255, 1)",u=e.styles.card.backgroundColorOff?e.styles.card.backgroundColorOff:"rgba(230, 230, 230, 0.5)",p=e.icon?e.icon:"mdi:alert-circle",g=e.styles.icon.size?e.styles.icon.size:1.3,f=e.styles.icon.color?e.styles.icon.color:"rgba(253, 216, 53, 1)",m=e.styles.icon.colorOff?e.styles.icon.colorOff:"rgba(0, 0, 0, 1)",v=e.styles.icon.position?e.styles.icon.position:"absolute",y=e.styles.icon.top?e.styles.icon.top:"15%",_=e.styles.icon.left?e.styles.icon.left:"10%",w=e.slider?e.slider:{},b=(e.styles.slider.position&&e.styles.slider.position,e.styles.slider.height?e.styles.slider.height:"40px"),S=e.styles.slider.backgroundColor?e.styles.slider.backgroundColor:"transparent",x=e.styles.slider.progressColor?e.styles.slider.progressColor:"green",$=e.slider.maxSet?e.slider.maxSet:100,C=e.slider.minSet?e.slider.minSet:0,T=e.slider.maxBar?e.slider.maxBar:100,k=e.slider.minBar?e.slider.minBar:0,P=e.row1.text?e.row1.text:"",N=e.row1.textOff?e.row1.textOff:"",M=e.styles.text.row1.color?e.styles.text.row1.color:"black",E=!e.styles.text.row1.oneLine||e.styles.text.row1.oneLine,A=e.styles.text.row1.size?e.styles.text.row1.size:"15px",O=e.row2.text?e.row2.text:"",V=e.row2.textOff?e.row2.textOff:"",D=e.styles.text.row2.color?e.styles.text.row2.color:"black",H=!e.styles.text.row2.oneLine||e.styles.text.row2.oneLine,Y=e.styles.text.row2.size?e.styles.text.row2.size:"13px",L=e.row3.text?e.row3.text:"",U=e.row3.textOff?e.row3.textOff:"",R=e.styles.text.row3.color?e.styles.text.row3.color:"black",j=!e.styles.text.row3.oneLine||e.styles.text.row3.oneLine,I=e.styles.text.row3.size?e.styles.text.row3.size:"13px";"<light_percentage>"===P?(""===N&&(N="0%"),P="off"===o.state?N:Math.round(o.attributes.brightness/2.55)+"%"):P=e.row1.text?e.row1.text:o.attributes.friendly_name,"<light_percentage>"===O&&(""===V&&(V="0%"),O="off"===o.state?V:Math.round(o.attributes.brightness/2.55)+"%"),"<light_percentage>"===L&&(""===U&&(U="0%"),L="off"===o.state?U:Math.round(o.attributes.brightness/2.55)+"%"),console.log("My-Button-Light -> ",this);const q=`\n\t\t\twidth: 100%;\n\t\t\theight: 100%;\n\t\t\tborder-radius: ${d};\n\t\t\tbackground-color: ${"off"===o.state?u:h};\n\t\t\toverflow: hidden;\n\t\t`,B=`\n\t\t\t--icon-color: ${"off"===o.state?m:f}; \n\t\t\t--icon-size: ${g};\n\t\t\t--icon-position: ${v}; \n\t\t\t--icon-top: ${y}; \n\t\t\t--icon-left: ${_};\n\t\t`;var F=`\n\t\t\t--card-height: ${r};\n\t\t\t--card-width: ${a};\n\t\t\t--card-border-radius: ${d};\n\t\t`,W=`\n\t\t\t--slider-height: ${b};\n\t\t\t--slider-width: ${c+10}px;\n\t\t\t--slider-left-pos: ${c/2-parseInt(b)/2+2}px;\n\t\t\t--slider-top-pos: ${c/2-parseInt(b)/2+2}px;\n\t\t\t--slider-background-color: ${S};\n\t\t\t--slider-progress-color: ${"off"===o.state||"locked"===o.state||null==o.state?"transparent":x}\n\n\t  \t`,J=`\n\t\t\t--row-1-color: ${M};\n\t\t\t--row-2-color: ${D};\n\t\t\t--row-3-color: ${R};\n\t\t\t--row-1-size: ${A};\n\t\t\t--row-1-line-height: ${parseInt(A)+2}px;\n\t\t\t--row-2-size: ${Y};\n\t\t\t--row-2-line-height: ${parseInt(Y)+2}px;\n\t\t\t--row-3-size: ${I};\n\t\t\t--row-3-line-height: ${parseInt(I)+2}px;\n\t\t`;return z`
			<ha-card style="${q}">

				<div class="root-container" style="${F}">
					${(()=>{let t=z``;return t="main"===s?z`
					<div class="info-container" style="${J}" 
						@action=${this._handleAction}
						.actionHandler=${Vt({hasHold:Pt(this.config.hold_action),hasDoubleClick:Pt(this.config.double_tap_action)})} >
							
						<p class="row-3 ${E?"text-oneline":"text"}">${L}</p>
						<p class="row-2 ${H?"text-oneline":"text"}">${O}</p>
						<p class="row-1 ${j?"text-oneline":"text"}">${P}</p>
				...
				`,t})()}
					...
					${(()=>{let t=z``;return t="icon"===s?z`
					<ha-icon class="my-button-light-icon" icon="${p}" style="${B}" 
					@action=${this._handleAction}
					.actionHandler=${Vt({hasHold:Pt(this.config.hold_action),hasDoubleClick:Pt(this.config.double_tap_action)})} ></ha-icon>
				`:z`
					<ha-icon class="my-button-light-icon" icon="${p}" style="${B}"></ha-icon>
				`,t})()}

					${(()=>{let t=z``;return console.log("Slider Config:::",w),(w||0!==Object.keys(w).length)&&(t=z`
					<input class="input-slider" id="${n}-slider" style="${W}" orient="vertical" type="range" step="1" 
						value="${"off"===o.state?0:Math.round(o.attributes.brightness/2.55)}" 
						min="${k}" max="${T}"
						@input=${t=>this._handleSliderAction(o,t.target,C,$)}>
				`),t})()}
				</div>

			</ha-card>
		`}_handleAction(t){console.log("Test 3"),this.hass&&this.config&&t.detail.action&&kt(this,this.hass,this.config,t.detail.action)}_handleSliderAction(t,e,i,n){let o=e.value;o>n?o=n:o<i&&(o=i),console.log("Handle Slider Action Event!",t),console.log("Target Value:::",o),e.value=o}_setSliderValueTransition(t,e,i){if(console.log("Setting Slider with Transition",t),i>e)for(var n=e;n<i;n++)setTimeout(()=>{console.log("Hello")},200);else for(n=i;n<e;n++);}static get styles(){const t=et`
